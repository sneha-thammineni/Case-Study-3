// Import React and WatchList 

import React from 'react';
import WatchListItem from './WatchListItem';


//React.createClass() to create component classes

const WatchList = React.createClass({
// Basically, getDefaultProps allows you to give your component some props which can be overridden
	getDefaultProps() {
		return {
			itemSpacing: 50
		};
